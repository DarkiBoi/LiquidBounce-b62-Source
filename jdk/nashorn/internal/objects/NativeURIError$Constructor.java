...
final class NativeURIError$Constructor extends ScriptFunction
{
    NativeURIError$Constructor() {
        ...
        // 
        // com.strobel.assembler.metadata.MethodBodyParseException: An error occurred while parsing the bytecode of method 'jdk/nashorn/internal/objects/NativeURIError$Constructor.<init>:()V'.
