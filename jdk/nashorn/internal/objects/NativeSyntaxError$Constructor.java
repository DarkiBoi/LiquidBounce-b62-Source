...
final class NativeSyntaxError$Constructor extends ScriptFunction
{
    NativeSyntaxError$Constructor() {
        ...
        // 
        // com.strobel.assembler.metadata.MethodBodyParseException: An error occurred while parsing the bytecode of method 'jdk/nashorn/internal/objects/NativeSyntaxError$Constructor.<init>:()V'.
