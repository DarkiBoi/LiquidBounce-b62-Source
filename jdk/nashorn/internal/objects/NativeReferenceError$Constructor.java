...
final class NativeReferenceError$Constructor extends ScriptFunction
{
    NativeReferenceError$Constructor() {
        ...
        // 
        // com.strobel.assembler.metadata.MethodBodyParseException: An error occurred while parsing the bytecode of method 'jdk/nashorn/internal/objects/NativeReferenceError$Constructor.<init>:()V'.
