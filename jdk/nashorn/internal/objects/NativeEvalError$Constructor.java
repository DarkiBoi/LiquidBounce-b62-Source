...
final class NativeEvalError$Constructor extends ScriptFunction
{
    NativeEvalError$Constructor() {
        ...
        // 
        // com.strobel.assembler.metadata.MethodBodyParseException: An error occurred while parsing the bytecode of method 'jdk/nashorn/internal/objects/NativeEvalError$Constructor.<init>:()V'.
