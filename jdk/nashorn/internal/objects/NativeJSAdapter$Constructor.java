...
final class NativeJSAdapter$Constructor extends ScriptFunction
{
    NativeJSAdapter$Constructor() {
        ...
        // 
        // com.strobel.assembler.metadata.MethodBodyParseException: An error occurred while parsing the bytecode of method 'jdk/nashorn/internal/objects/NativeJSAdapter$Constructor.<init>:()V'.
