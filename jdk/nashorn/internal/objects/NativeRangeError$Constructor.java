...
final class NativeRangeError$Constructor extends ScriptFunction
{
    NativeRangeError$Constructor() {
        ...
        // 
        // com.strobel.assembler.metadata.MethodBodyParseException: An error occurred while parsing the bytecode of method 'jdk/nashorn/internal/objects/NativeRangeError$Constructor.<init>:()V'.
