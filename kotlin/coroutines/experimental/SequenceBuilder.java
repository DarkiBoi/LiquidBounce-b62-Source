...
public abstract class SequenceBuilder<T>
{
    ...
    @Nullable
    public final Object yieldAll(@NotNull final Iterable<? extends T> elements, @NotNull final Continuation<? super Unit> continuation) {
        if (elements instanceof Collection && ((Collection)elements).isEmpty()) {
            return Unit.INSTANCE;
        }
        return this.yieldAll(elements.iterator(), continuation);
    }
