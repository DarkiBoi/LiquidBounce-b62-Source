...
final class ExperimentalSuspendFunction1Migration<T1, R> implements Function2<T1, Continuation<? super R>, Object>
{
    ...
    @Nullable
    @Override
    public Object invoke(final T1 t1, @NotNull final Continuation<? super R> continuation) {
    ...
    public ExperimentalSuspendFunction1Migration(@NotNull final Function2<? super T1, ? super kotlin.coroutines.Continuation<? super R>, ?> function) {
        Intrinsics.checkParameterIsNotNull(function, "function");
        this.function = (Function2<T1, kotlin.coroutines.Continuation<? super R>, Object>)function;
    }
}
