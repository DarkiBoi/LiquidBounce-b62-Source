...
final class ExperimentalSuspendFunction0Migration<R> implements Function1<Continuation<? super R>, Object>
{
    ...
    @Nullable
    @Override
    public Object invoke(@NotNull final Continuation<? super R> continuation) {
    ...
    public ExperimentalSuspendFunction0Migration(@NotNull final Function1<? super kotlin.coroutines.Continuation<? super R>, ?> function) {
        Intrinsics.checkParameterIsNotNull(function, "function");
        this.function = (Function1<kotlin.coroutines.Continuation<? super R>, Object>)function;
    }
}
