...
final class ExperimentalSuspendFunction2Migration<T1, T2, R> implements Function3<T1, T2, Continuation<? super R>, Object>
{
    ...
    @Nullable
    @Override
    public Object invoke(final T1 t1, final T2 t2, @NotNull final Continuation<? super R> continuation) {
    ...
    public ExperimentalSuspendFunction2Migration(@NotNull final Function3<? super T1, ? super T2, ? super kotlin.coroutines.Continuation<? super R>, ?> function) {
        Intrinsics.checkParameterIsNotNull(function, "function");
        this.function = (Function3<T1, T2, kotlin.coroutines.Continuation<? super R>, Object>)function;
    }
}
