...
public final class ContinuationKt
{
    ...
    @InlineOnly
    private static final <T> void resume(@NotNull final Continuation<? super T> $receiver, final T value) {
        final Result.Companion companion = Result.Companion;
        $receiver.resumeWith(Result.constructor-impl(value));
    }
    
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <T> void resumeWithException(@NotNull final Continuation<? super T> $receiver, final Throwable exception) {
        final Result.Companion companion = Result.Companion;
        $receiver.resumeWith(Result.constructor-impl(ResultKt.createFailure(exception)));
    }
    ...
    public static final <T> Continuation<Unit> createCoroutine(@NotNull final Function1<? super Continuation<? super T>, ?> $receiver, @NotNull final Continuation<? super T> completion) {
        ...
        return new SafeContinuation<Unit>(IntrinsicsKt__IntrinsicsJvmKt.intercepted((Continuation<? super Unit>)IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted((Function1<? super Continuation<? super Object>, ?>)$receiver, (Continuation<? super Object>)completion)), IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED());
    }
    ...
    public static final <T> void startCoroutine(@NotNull final Function1<? super Continuation<? super T>, ?> $receiver, @NotNull final Continuation<? super T> completion) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        final Continuation<Object> intercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted((Continuation<? super Object>)IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted((Function1<? super Continuation<? super Object>, ?>)$receiver, (Continuation<? super Object>)completion));
    ...
    public static final <R, T> void startCoroutine(@NotNull final Function2<? super R, ? super Continuation<? super T>, ?> $receiver, final R receiver, @NotNull final Continuation<? super T> completion) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        final Continuation<Object> intercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted((Continuation<? super Object>)IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted((Function2<? super R, ? super Continuation<? super Object>, ?>)$receiver, receiver, (Continuation<? super Object>)completion));
        final Unit instance = Unit.INSTANCE;
        final Continuation<Object> continuation = intercepted;
        final Result.Companion companion = Result.Companion;
        continuation.resumeWith(Result.constructor-impl(instance));
