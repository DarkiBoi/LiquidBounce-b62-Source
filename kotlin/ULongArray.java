...
public final class ULongArray implements Collection<ULong>, KMappedMarker
{
    ...
    public static final long get-impl(final long[] $this, final int index) {
        return ULong.constructor-impl($this[index]);
    }
    
    public static final void set-k8EXiF4(final long[] $this, final int index, final long value) {
        $this[index] = value;
    }
    
    public static int getSize-impl(final long[] $this) {
        return $this.length;
    }
    
    @NotNull
    public static ULongIterator iterator-impl(final long[] $this) {
        return new Iterator($this);
    }
    
    public static boolean contains-VKZWuLQ(final long[] $this, final long element) {
        return ArraysKt___ArraysKt.contains($this, element);
    }
    
    public static boolean containsAll-impl(final long[] $this, @NotNull final Collection<ULong> elements) {
        ...
        if (((Collection)$receiver$iv).isEmpty()) {
            ...
            for (final Object element$iv : $receiver$iv) {
                final long it = ((ULong)element$iv).unbox-impl();
    ...
    public static boolean isEmpty-impl(final long[] $this) {
    ...
    public static String toString-impl(final long[] a) {
        return "ULongArray(storage=" + Arrays.toString(a) + ")";
    }
    ...
    public static boolean equals-impl(final long[] first, @Nullable final Object o) {
        return o instanceof ULongArray && Intrinsics.areEqual(first, ((ULongArray)o).unbox-impl());
    }
    
    public static final boolean equals-impl0(@NotNull final long[] p1, @NotNull final long[] p2) {
