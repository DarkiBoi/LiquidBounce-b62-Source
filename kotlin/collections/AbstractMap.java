...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker
{
    ...
    public boolean containsValue(final Object value) {
        final Iterable $receiver$iv = this.entrySet();
        boolean b;
    ...
    public boolean equals(@Nullable final Object other) {
        ...
        final Iterable $receiver$iv = ((Map)other).entrySet();
        boolean b;
        if ($receiver$iv instanceof Collection && ((Collection)$receiver$iv).isEmpty()) {
            b = true;
        }
    ...
    public static final class Companion
    {
        public final int entryHashCode$kotlin_stdlib(@NotNull final Entry<?, ?> e) {
            ...
            final Entry $receiver = e;
            final Object key = $receiver.getKey();
            final int n = (key != null) ? key.hashCode() : 0;
            final Object value = $receiver.getValue();
        ...
        public final String entryToString$kotlin_stdlib(@NotNull final Entry<?, ?> e) {
            Intrinsics.checkParameterIsNotNull(e, "e");
            final Entry $receiver = e;
            return new StringBuilder().append($receiver.getKey()).append('=').append($receiver.getValue()).toString();
        }
