...
class ComparisonsKt__ComparisonsKt
{
    ...
    @InlineOnly
    private static final <T> Comparator<T> thenBy(@NotNull final Comparator<T> $receiver, final Function1<? super T, ? extends Comparable<?>> selector) {
        return (Comparator<T>)new ComparisonsKt__ComparisonsKt$thenBy.ComparisonsKt__ComparisonsKt$thenBy$1((Comparator)$receiver, (Function1)selector);
    }
    
    @InlineOnly
    private static final <T, K> Comparator<T> thenBy(@NotNull final Comparator<T> $receiver, final Comparator<? super K> comparator, final Function1<? super T, ? extends K> selector) {
        return (Comparator<T>)new ComparisonsKt__ComparisonsKt$thenBy.ComparisonsKt__ComparisonsKt$thenBy$2((Comparator)$receiver, (Comparator)comparator, (Function1)selector);
    }
    
    @InlineOnly
    private static final <T> Comparator<T> thenByDescending(@NotNull final Comparator<T> $receiver, final Function1<? super T, ? extends Comparable<?>> selector) {
        return (Comparator<T>)new ComparisonsKt__ComparisonsKt$thenByDescending.ComparisonsKt__ComparisonsKt$thenByDescending$1((Comparator)$receiver, (Function1)selector);
    }
    
    @InlineOnly
    private static final <T, K> Comparator<T> thenByDescending(@NotNull final Comparator<T> $receiver, final Comparator<? super K> comparator, final Function1<? super T, ? extends K> selector) {
        return (Comparator<T>)new ComparisonsKt__ComparisonsKt$thenByDescending.ComparisonsKt__ComparisonsKt$thenByDescending$2((Comparator)$receiver, (Comparator)comparator, (Function1)selector);
    }
    
    @InlineOnly
    private static final <T> Comparator<T> thenComparator(@NotNull final Comparator<T> $receiver, final Function2<? super T, ? super T, Integer> comparison) {
        return (Comparator<T>)new ComparisonsKt__ComparisonsKt$thenComparator.ComparisonsKt__ComparisonsKt$thenComparator$1((Comparator)$receiver, (Function2)comparison);
    }
    ...
    public static final <T> Comparator<T> then(@NotNull final Comparator<T> $receiver, @NotNull final Comparator<? super T> comparator) {
        ...
        return (Comparator<T>)new ComparisonsKt__ComparisonsKt$then.ComparisonsKt__ComparisonsKt$then$1((Comparator)$receiver, (Comparator)comparator);
    }
    ...
    public static final <T> Comparator<T> thenDescending(@NotNull final Comparator<T> $receiver, @NotNull final Comparator<? super T> comparator) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Intrinsics.checkParameterIsNotNull(comparator, "comparator");
        return (Comparator<T>)new ComparisonsKt__ComparisonsKt$thenDescending.ComparisonsKt__ComparisonsKt$thenDescending$1((Comparator)$receiver, (Comparator)comparator);
    }
    ...
    @NotNull
    public static final <T> Comparator<T> reversed(@NotNull final Comparator<T> $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Object comparator;
        if ($receiver instanceof ReversedComparator) {
            comparator = ((ReversedComparator<T>)$receiver).getComparator();
        }
        else if (Intrinsics.areEqual($receiver, NaturalOrderComparator.INSTANCE)) {
            final ReverseOrderComparator instance = ReverseOrderComparator.INSTANCE;
            if (instance == null) {
                throw new TypeCastException("null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
            }
            ...
            comparator = new ReversedComparator<Object>($receiver);
        }
