...
public interface ClosedFloatingPointRange<T extends Comparable<? super T>> extends ClosedRange<T>
{
    ...
    {
        public static <T extends Comparable<? super T>> boolean contains(final ClosedFloatingPointRange<T> $this, @NotNull final T value) {
            Intrinsics.checkParameterIsNotNull(value, "value");
            return $this.lessThanOrEquals($this.getStart(), value) && $this.lessThanOrEquals(value, $this.getEndInclusive());
        }
        
        public static <T extends Comparable<? super T>> boolean isEmpty(final ClosedFloatingPointRange<T> $this) {
