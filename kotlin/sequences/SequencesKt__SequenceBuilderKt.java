...
class SequencesKt__SequenceBuilderKt
{
    ...
    private static final <T> Sequence<T> buildSequence(@BuilderInference final Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ?> builderAction) {
    ...
    @InlineOnly
    @java.lang.Deprecated
    private static final <T> Iterator<T> buildIterator(@BuilderInference final Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ?> builderAction) {
        return (Iterator<T>)iterator((Function2<? super SequenceScope<? super Object>, ? super Continuation<? super Unit>, ?>)builderAction);
    }
